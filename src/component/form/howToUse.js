...
const HowToUse = () => {
  ...
  return (
    <>
      ...
      >
        <div className="mb-4 border border-gray-100 dark:text-gray-50 dark:border-dbeats-light dark:border-opacity-10 bg-blue-100 nm-flat-dbeats-dark-primary  rounded-2xl shadow-sm dark:shadow-md    text-dbeats-dark-primary p-4    dialog ">
          <div>
